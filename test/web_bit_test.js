  ...
  describe('WebPage', function(){
    ...
    describe( '#setContent', function(){
      ...
      it( 'all html auto-rendered nested WebBits are cleaned out in new content value', function( done ){
        var self = this;
        var orig = "<div data-web-bit-root=\"true\"><div data-web-bit-id=\"wb1\" data-web-bit-name=\"Main Menu\"></div><div data-web-bit-id=\"wb5\" data-web-bit-name=\"Hero Header\"></div><div data-web-bit-id=\"wb2\" data-web-bit-name=\"1 of 3 Columns\"></div><div data-web-bit-id=\"wb3\" data-web-bit-name=\"2 of 3 Columns\"></div><div data-web-bit-id=\"wb4\" data-web-bit-name=\"3 of 3 Columns\"></div></div>";
